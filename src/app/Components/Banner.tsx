...
<div>
    ...
    <section className=' flex items-center p-16' >
     ...
     <h1 className='text-[#38F881] text-7xl font-bold'>Get More Done with
      Whitepace</h1>
...
<img src='/Images/Image.png' alt=''></img>
    ...
    <section className=' flex items-center p-16' >
     ...
     <h1 className='text-black text-7xl font-bold'>Project Management</h1>
      <p >
...
<img src='/Images/Image.png' alt=''></img>
    ...
    <section className='flex items-center p-16 gap-9' >
...
<h1 className='text-7xl font-bold'>Work<br></br>
Together</h1>
 ...
 <img src='/Images/Frame Green Button.png' alt=''></img>
    ...
    <section className=' bg-[#222222] flex items-center p-16' >

<div className='leading-10 gap-14'>

<h1 className='text-[#38F881] text-7xl font-bold'>Use as<br></br>
Extension</h1>
...
<h1 className='text-7xl font-bold'>Customise it to<br></br>
your needs</h1>
