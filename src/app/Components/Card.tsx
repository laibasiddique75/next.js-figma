...
const Card = () => {
  ...
  <section className='m-9 border-2 border-red-500 rounded-3xl w-[400px] h-1/4 p-10 ' >

<div >

  <p className='font-bold text-3xl'>Free</p>
  <h1 className='text-red-500 font-bold text-5xl'>$  0</h1>
...
<div className='flex'>
 ...
 <div className='flex'><img src='/Images/la_check-circle-solid.png' alt=''></img> <p>Customize Home dashboard and access extra</p></div>
  ...
  <section className='m-9 border-2 bg-red-500 text-white border-red-500 rounded-3xl w-[400px] h-1/4 p-10 ' >

<div >

  <p className='font-bold text-3xl'>Personal</p>
  <h1 className='text-green-500 font-bold text-5xl'>$ 11.99</h1>
...
<div >
  ...
  <p className='font-bold text-3xl'>Organization</p>
  <h1 className='text-red-500 font-bold text-5xl'>$  49.99</h1>
  <h2>Capture ideas and find them quickly</h2>
